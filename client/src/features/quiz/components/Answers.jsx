...
const EmptyState = () => (
	<div className="py-20 text-center">
		...
		<h3 className="text-lg font-bold text-gray-800">No submissions yet</h3>
...
export default function Answers() {
	...
	return (
		<div className="py-4 sm:py-8">
			...
			<div className="bg-white rounded-3xl sm:rounded-4xl shadow-sm border border-gray-100 overflow-hidden">
